...
``Aliás,\footnote{Esta tradução baseia-se na edição crítica
  ...
  Relume Dumará, 2003; \emph{Considérations inactuelles \versal{I} et \versal{II}}. Trad.
...
dedo.\footnote{O discípulo de Heráclito em questão é Crátilo. (Cf. Livro
  \versal{IV} da \emph{Metafísica} de Aristóteles).} A toda ação pertence o
...
discípulos de Pitágoras diziam reconhecer seu mestre.\footnote{Anedota
  presente no livro \versal{VIII} de \emph{Vida e opiniões dos mais eminentes
...
dos utensílios ancestrais\footnote{Referência ao \emph{Fausto}, de
  Goethe, \versal{I}, linha 408.} modifica suas ideias: ele passa a ser por eles
...
poder-se-ia então considerar a dita União Protestante\footnote{Instituição
  alemã, fundada no século \versal{XIX}, que unia diversos segmentos da igreja
...
enigmas do devir, expressos no homem moderno como fruto mais maduro
    ...
    Europeu orgulhoso do século \versal{XIX}, você está perdendo o juízo!
    ...
    prodigus}\footnote{``Pródigo de grande alma''\textbf{.} Expressão de
      Horácio, \emph{Odes \versal{I}}, significando ``sem cuidado com a vida''.}. Se, ao
